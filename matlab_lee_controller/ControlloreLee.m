function out = ControlloreLee(u,P)
...
if t == 0
    ...
    dx2dt = DirtyDerivative(2, P.tau*2, P.Ts); % ex *10 su quelle di ordine >=2
    dx3dt = DirtyDerivative(3, P.tau*2, P.Ts);
    dx4dt = DirtyDerivative(4, P.tau*2, P.Ts);
    
    db1dt = DirtyDerivative(1, P.tau, P.Ts);
    db2dt = DirtyDerivative(2, P.tau*2, P.Ts);
    
    dv1dt = DirtyDerivative(1, P.tau, P.Ts);
    dv2dt = DirtyDerivative(2, P.tau*2, P.Ts);
end
